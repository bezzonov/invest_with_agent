...
model_params = {
    ...
    "PPO (Proximal Policy Optimization)" : {
        'total_timesteps' : {"label": "total_timesteps", "type": "number_input", "min_value": 5000, "max_value": 1000000, "value": 20000, "step": 5000, 'help':'Определяет общее количество шагов среды (environment steps), на которых будет обучаться агент.'},
