...
model_params = {
    ...
    "A2C (Advantage Actor Critic)" : {
        ...
        'ent_coef' :      {"label": "ent_coef", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.01, "step": 0.01, "format": "%.3f", 'help':'Коэффициент энтропии, который используется при вычислении функции потерь. Он регулирует влияние энтропии на общий лосс, стимулируя исследование (exploration) агентом.'},
        'gae_lambda':     {"label": "gae_lambda", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.95, "step": 0.01, "format": "%.3f", 'help':'Коэффициент, позволяющий найти компромисс между погрешностью и дисперсией для обобщенной оценки преимущества. Эквивалентно классическому преимуществу при значении 1.'},
        'gamma':          {"label": "gamma", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.98, "step": 0.01, "format": "%.3f", 'help':'Коэффициент дисконтирования будущих наград. Он определяет, насколько сильно агент учитывает будущие вознаграждения по сравнению с текущими.'},
        'max_grad_norm':  {"label": "max_grad_norm", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.5, "step": 0.01, "format": "%.3f", 'help':'Максимальное значение для обрезки градиента.'},
        'n_steps':  {"label": "n_steps", "type": "slider", "min_value": 1.0, "max_value": 10.0, "value": 3.0, "step": 1.0, "format": "%.2f", 'help':'Количество шагов, выполняемых для каждой среды при каждом обновлении (т.е. размер пакета равен n_steps * n_env, где n_env - количество копий среды, выполняемых параллельно'},
        ...
        'alpha':  {"label": "alpha",  "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.7, "step": 0.01, "format": "%.3f", 'help':'Параметр, который регулирует скорость или степень обновления модели в процессе обучения, влияя на стабильность и скорость сходимости алгоритма.'},
        'eps' : {"label": "eps rate", "type": "number_input", "min_value": 1e-06, "max_value":1e-02, "value": 1e-04, "step": 0.0001, "format": "%.4f", 'help':'Маленькое число для численной стабильности, например, добавляется к вероятностям или значениям для предотвращения ошибок вычислений.'},
    },

    "PPO (Proximal Policy Optimization)" : {
        'learning_rate' : {"label": "learning rate", "type": "number_input", "min_value": 0.0001, "max_value": 1.0, "value": 0.005, "step": 0.0001, "format": "%.4f", 'help':'Настраиваемый параметр алгоритма оптимизации, который определяет размер шага на каждой итерации, при движении к минимуму функции потерь.'},
        'batch_size' :    {"label": "batch_size", "type": "slider", "min_value": 16, "max_value": 512, "value": 64, "step": 2, "format": "%.3f", 'help':'Размер мини-батча определяет сколько примеров опыта используется за один шаг оптимизации. Меньшие значения ускоряют обучение, но могут снизить стабильность.'},
        'ent_coef' :      {"label": "ent_coef", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.01, "step": 0.01, "format": "%.3f", 'help':'Коэффициент энтропии, который используется при вычислении функции потерь. Он регулирует влияние энтропии на общий лосс, стимулируя исследование (exploration) агентом.'},
        'vf_coef' :      {"label": "vf_coef", "type": "slider", "min_value": 0.1, "max_value": 1.0, "value": 0.5, "step": 0.05, "format": "%.3f", 'help':'Коэффициент функции ценности, балансирует вклад функции ценности в общую функцию потерь. Увеличение значения усиливает влияние ошибок предсказания ценности состояния.'},
        'gae_lambda':     {"label": "gae_lambda", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.95, "step": 0.01, "format": "%.3f", 'help':'Коэффициент, позволяющий найти компромисс между погрешностью и дисперсией для обобщенной оценки преимущества. Эквивалентно классическому преимуществу при значении 1.'},
        'gamma':          {"label": "gamma", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.98, "step": 0.01, "format": "%.3f", 'help':'Коэффициент дисконтирования будущих наград. Он определяет, насколько сильно агент учитывает будущие вознаграждения по сравнению с текущими.'},
        'max_grad_norm':  {"label": "max_grad_norm", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.5, "step": 0.01, "format": "%.3f", 'help':'Максимальное значение для обрезки градиента.'},
        'n_steps':  {"label": "n_steps", "type": "slider", "min_value": 1.0, "max_value": 10.0, "value": 3.0, "step": 1.0, "format": "%.2f", 'help':'Количество шагов, выполняемых для каждой среды при каждом обновлении (т.е. размер пакета равен n_steps * n_env, где n_env - количество копий среды, выполняемых параллельно'},
    ...
    "DDPG (Deep Deterministic Policy Gradient)" : {
        'learning_rate' : {"label": "learning rate", "type": "number_input", "min_value": 0.0001, "max_value": 1.0, "value": 0.005, "step": 0.0001, "format": "%.4f", 'help':'Настраиваемый параметр алгоритма оптимизации, который определяет размер шага на каждой итерации, при движении к минимуму функции потерь.'},
        'batch_size' :    {"label": "batch_size", "type": "slider", "min_value": 16, "max_value": 512, "value": 64, "step": 2, "format": "%.3f", 'help':'Размер мини-батча определяет сколько примеров опыта используется за один шаг оптимизации. Меньшие значения ускоряют обучение, но могут снизить стабильность.'},
        'buffer_size' : {"label": "buffer_size", "type": "number_input", "min_value": 10000.0, "max_value": 200000.0, "value": 50000.0, "step": 10000.0, "format": "%.1f", 'help':'Означает размер буфера воспроизведения (replay buffer) - количество сохранённых переходов (опыта) агента, которые могут использоваться для обучения.'},
        'gamma':          {"label": "gamma", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.98, "step": 0.01, "format": "%.3f", 'help':'Коэффициент дисконтирования будущих наград. Он определяет, насколько сильно агент учитывает будущие вознаграждения по сравнению с текущими.'},
        'gradient_steps':          {"label": "gradient_steps", "type": "slider", "min_value": -1.0, "max_value": 10.0, "value": 2.0, "step": 1.0, "format": "%.1f", 'help':'Контролирует, сколько раз модель обновляется на основе накопленного опыта из replay buffer после каждого взаимодействия с окружением.'},
        ...
        'tau':          {"label": "tau", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.05, "step": 0.01, "format": "%.3f", 'help':'Коэффициент «мягкого» обновления целевых сетей актёра и критика.'},
        'optimize_memory_usage':  {"label": "optimize_memory_usage", "type": "selectbox", 'options' :[True, False], 'help':'Отвечает за оптимизацию использования памяти при хранении опыта в replay buffer'}
    },
    ...
    "TD3 (Twin Delayed DDPG)" : {
        ...
        'learning_starts' : {"label": "learning_starts", "type": "number_input", "min_value": 100.0, "max_value": 1000.0, "value": 500.0, "step": 50.0, "format": "%.1f", 'help':'Определяет, сколько шагов взаимодействия с окружением агент должен накопить в буфере воспроизведения (replay buffer) до начала обучения.'},
        'buffer_size' : {"label": "buffer_size", "type": "number_input", "min_value": 10000.0, "max_value": 200000.0, "value": 50000.0, "step": 10000.0, "format": "%.1f", 'help':'Означает размер буфера воспроизведения (replay buffer) - количество сохранённых переходов (опыта) агента, которые могут использоваться для обучения.'},
        'train_freq':          {"label": "train_freq", "type": "slider", "min_value": 1.0, "max_value": 100.0, "value": 10.0, "step": 1.0, "format": "%.1f", 'help':'Определяет, как часто вызывается функция обучения (train) и выполняются градиентные шаги.'},
        'gamma':          {"label": "gamma", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.98, "step": 0.01, "format": "%.3f", 'help':'Коэффициент дисконтирования будущих наград. Он определяет, насколько сильно агент учитывает будущие вознаграждения по сравнению с текущими.'},
        'tau':          {"label": "tau", "type": "slider", "min_value": 0.01, "max_value": 1.0, "value": 0.05, "step": 0.01, "format": "%.3f", 'help':'Коэффициент «мягкого» обновления целевых сетей актёра и критика.'},
        'optimize_memory_usage':  {"label": "optimize_memory_usage", "type": "selectbox", 'options' :[True, False], 'help':'Отвечает за оптимизацию использования памяти при хранении опыта в replay buffer'}
    }
