...
model_params = {
    ...
    "A2C (Advantage Actor Critic)" : {
        'total_timesteps' : {"label": "total_timesteps", "type": "number_input", "min_value": 10000, "max_value": 1000000, "value": 50000, "step": 10000, 'help':'Определяет общее количество шагов среды (environment steps), на которых будет обучаться агент.'},
        ...
        'n_steps':  {"label": "n_steps", "type": "slider", "min_value": 1.0, "max_value": 10.0, "value": 3.0, "step": 1.0, 'help':'Количество шагов, выполняемых для каждой среды при каждом обновлении (т.е. размер пакета равен n_steps * n_env, где n_env - количество копий среды, выполняемых параллельно'},
